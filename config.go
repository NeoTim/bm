...
func defaultConfig() (Config, error) {
	...
	config.StorePath = filepath.Join(currentUser.HomeDir, BaseDir, DefaultStorageFolder)
	return config, nil
}
...
func configFilePath() (string, error) {
	...
	return filepath.Join(currentUser.HomeDir, BaseDir, ConfigFile), nil
}
...
func initBaseDir() error {
	...
	baseDir := filepath.Join(currentUser.HomeDir, BaseDir)
